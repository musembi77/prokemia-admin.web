...
const Distributor=({distributor_data})=>{
	...
	return(
		<Flex boxShadow='lg' gap='1' bg='#fff' borderRadius='5'>
			<Image boxSize='150px' src={distributor_data?.profile_photo_url == '' || !distributor_data?.profile_photo_url ? './Pro.png' : distributor_data?.profile_photo_url} bg='grey' alt='photo' objectFit='cover' border='1px solid #eee' borderRadius='5'/>
